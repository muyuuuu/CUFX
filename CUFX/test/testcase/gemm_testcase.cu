...
TestCase(CudaOp, GemmFloat) {
    ...
    Matrix dst1{ElemType::ElemFloat, {256, 256, 1}, MemoryType::GlobalMemory, IsAsync::IsAsyncFalse};
    Matrix dst2{ElemType::ElemFloat, {256, 256, 1}, MemoryType::GlobalMemory, IsAsync::IsAsyncFalse};
