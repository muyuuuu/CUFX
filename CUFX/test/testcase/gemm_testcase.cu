...
TestCase(CudaOp, GemmFloat) {
    ...
    Matrix dst1{ElemType::ElemFloat, {201, 327, 1}, MemoryType::GlobalMemory, IsAsync::IsAsyncFalse};
    Matrix dst2{ElemType::ElemFloat, {201, 327, 1}, MemoryType::GlobalMemory, IsAsync::IsAsyncFalse};
